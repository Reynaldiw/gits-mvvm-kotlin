...
import id.gits.gitsmvvmkotlin.data.source.remote.ApiCallback
...
open class GitsRepository(val remoteDataSource: GitsRemoteDataSource,
    ...
    private fun getRemoteTeamsSource(callback: GitsDataSource.GetTeamsCallback) {
        remoteDataSource.getTeams(object : GitsDataSource.GetTeamsCallback {
            override fun onShowProgressDialog() {
                callback.onShowProgressDialog()
            }

...
import id.gits.gitsmvvmkotlin.mvvm.teams.TeamFragment
...
class MainActivity : BaseActivity() {
    ...
    private fun setupMainFragment() {
        replaceFragmentInActivity(TeamFragment.newInstance(), R.id.frame_main_content)
    }

    fun obtainViewModel(): MainViewModel = obtainViewModel(MainViewModel::class.java)

    fun obtainTeamViewModel() : TeamViewModel = obtainViewModel(TeamViewModel::class.java)
